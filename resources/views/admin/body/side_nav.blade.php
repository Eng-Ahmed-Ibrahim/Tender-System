                        ...
                        <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="{{ route('categories.index')}}">
                                            ...
                                            <span class="menu-title">{{ __('Main categories')}} </span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">{{ __('Normal ADs')}}</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="{{ route('popup.index')}}">
                                            ...
                                            <span class="menu-title">{{ __('popup')}}</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
        ...
        <!--end:Menu link-->
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('Normaldevice.index')}}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">{{__('Device normal')}}</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="{{ route('device.commercial')}}">
                                            ...
                                            <span class="menu-title">{{__('Device commercial')}}</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                            ...
                            <div class="menu-item pt-5">
                                <!--begin:Menu content-->
                                <div class="menu-content">
                                    <span class="menu-heading fw-bold text-uppercase fs-7">{{__('Repesntative')}}</span>
                                </div>
                                <!--end:Menu content-->
                            </div>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">{{__('Repesntative')}}</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <!--end:Menu link-->
                                <!--begin:Menu sub-->
