                            ...
                            <div class="m-0">
                                ...
                                <div class="row g-5 mb-11">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="fw-bold fs-6 text-gray-800">{{ $bill->subscription_end_date }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-5 mb-12">
                                    <div class="col-sm-6">
                                        ...
                                        @else
                                            <div class="fw-bold fs-6 text-gray-800">Unknown Customer</div>
                                        @endif
                                    </div>
                                    <div class="col-sm-6">
                    ...
                    <div class="m-0">
                        <div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
                            ...
                            <div class="mb-6">
                                ...
                                @else
                                    <div class="fw-bold text-gray-800 fs-6">Not Available</div>
                                @endif
                            </div>

                            <div class="mb-6">
                                <div class="fw-semibold text-gray-600 fs-7">Subscription Plan:</div>
                                @if (isset($bill->customerSubscription) && isset($bill->customerSubscription->subscriptionPlan))
                                    <div class="fw-bold text-gray-800 fs-6">{{ $bill->customerSubscription->subscriptionPlan->name }}</div>
                                @else
                                    <div class="fw-bold text-gray-800 fs-6">No Subscription Plan Available</div>
                                @endif
                            </div>

                            <div class="mb-6">
                                <div class="fw-semibold text-gray-600 fs-7">Status:</div>
                                <div class="fw-bold text-gray-800 fs-6">{{ $bill->status }}</div>
                            </div>

                            <div class="mb-6">
                                <div class="fw-semibold text-gray-600 fs-7">Notes:</div>
                                <div class="fw-bold text-gray-800 fs-6">{{ $bill->notes }}</div>
                            </div>
                        </div>
                    </div>
                </div>
