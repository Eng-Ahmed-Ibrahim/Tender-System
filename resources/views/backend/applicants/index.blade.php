            ...
            <div class="card-body pt-5">
                <form id="filterForm" class="row g-4">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="position-relative">
                            ...
                            <input type="text" class="form-control form-control-solid ps-12"
                                placeholder="{{ __('Search applicants...') }}" name="search"
                                value="{{ request('search') }}" data-kt-filter="search" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3" style="padding-top:9px;">
                        ...
                        <select class="form-select form-select-solid" name="tender" data-control="select2"
                    ...
                    <div class="col-12 col-md-3" style="padding-top:9px;">
                        ...
                        <select class="form-select form-select-solid" name="company" data-control="select2"
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <div class="position-relative">
                            ...
                            <input class="form-control form-control-solid ps-12" placeholder="{{ __('Pick date range') }}"
                                id="dateRangePicker" />
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (window.jQuery && jQuery.fn.daterangepicker) {
            ...
            jQuery('#dateRangePicker').on('apply.daterangepicker', function(ev, picker) {
                jQuery(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format(
                    'MM/DD/YYYY'));
