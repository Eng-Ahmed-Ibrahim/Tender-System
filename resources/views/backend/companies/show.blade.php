...
@section('content')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <div class="d-flex align-items-center mb-2">
                        <div class="company-avatar me-3">
                            @if ($company->logo)
                                <img src="{{ asset('storage/' . $company->logo) }}" alt="Company Logo" class="rounded-3"
                                    style="width: 64px; height: 64px; object-fit: cover;">
                            @else
                                <div class="placeholder-avatar rounded-3 bg-light d-flex align-items-center justify-content-center"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <form action="{{ route('companies.destroy', $company->id) }}" method="POST" class="mx-0">
                        ...
                        @method('DELETE')
                        <button type="submit"
                            class="btn btn-danger btn-sm d-inline-flex align-items-center justify-content-center action-btn"
                    ...
                    <div class="card-body">
                        <div class="company-info">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <span
                                    class="badge bg-{{ $company->status === 'active' ? 'success' : 'danger' }} rounded-pill px-3 py-2">
                                        ...
                                        <div class="stat-card bg-success bg-opacity-10 p-3 rounded-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <div class="stat-label text-muted small">{{ __('Commercial Photo') }}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-3 text-center">
                                                @if ($company->commercial_photo)
                                                    <img src="{{ asset('storage/' . $company->commercial_photo) }}"
                                                        alt="Commercial Photo" class="img-fluid rounded-3"
                                        ...
                                        <tbody>
                                            @foreach ($company->users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge bg-{{ $user->is_active === 1 ? 'success' : 'danger' }} rounded-pill">
                                                                ...
                                                                <li>
                                                                    <form
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            <i
                                                                                class="fa fa-{{ $user->is_active ? 'ban' : 'check' }} me-2"></i>
                ...
                <form id="addUserForm">
                    ...
                    <div class="modal-body">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold">{{ __('Email') }}<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold">{{ __('Role') }}<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold">{{ __('Password') }}<span
                                        class="text-danger">*</span></label>
                                <input type="password" name="password" class="form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">{{ __('Confirm Password') }}<span
                                        class="text-danger">*</span></label>
    ...
    <!-- Add Tender Modal -->
    <div class="modal fade" id="addTenderModal" tabindex="-1" aria-labelledby="addTenderModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
